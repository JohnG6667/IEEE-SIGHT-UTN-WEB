                                            ...
                                            <div class="post-grid reverse-grid">
                                                ...
                                                <div class="post-text-block bg-gray-light">
                                                    <strong class="content-title mb-0"><a
                                                        ...
                                                        overflow: hidden;" title="{{ $event->title }}">{{ $event->title }}</a></strong>
                                                    <p
                                                        style="display: -webkit-box;
                                                    -webkit-line-clamp: 4;
                                                    -webkit-box-orient: vertical;
                                ...
                                <div class="post-block">
                                    ...
                                    @if ($popular_events->count())
                                        @foreach ($popular_events as $event)
                                            <div class="post-holder"><a href="{{ route('events.show', $event) }}" class="post-link"></a>
                                                <div class="post-avatar">
                                                    <a href="{{ route('events.show', $event) }}"><img src="img/thumb.jpg"
                                                            alt="image description"></a>
                                                </div>
                                                <div class="post-desc">
                                                    <h6 title="{{$event->title}}"><a style="display: -webkit-box;
                                                        -webkit-line-clamp: 2;
                                                        -webkit-box-orient: vertical;
                                                        overflow: hidden;" href="{{ route('events.show', $event) }}">{{$event->title}}</a></h6>
                                                    <p><a href="{{ route('events.show', $event) }}">{{$event->suggestions()->count()}} Sugerencias</a></p>
                                                </div>
                                            </div>
                                        @endforeach
                                    @endif
