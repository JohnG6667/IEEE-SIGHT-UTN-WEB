                                ...
                                <div class="signup-wrap text-center">
                                    <div class="inner-wrap">
                                        ...
                                        <form method="POST" action="{{ route('password.email') }}"
                                            ...
                                            <p>Para recibir una nueva contraseña, introduzca su dirección de correo electrónico a continuación.</p>
                                            <div class="form-group">
                                                <input placeholder="Enter Your Email...." id="email" type="email" name="email"
                                                :value="old('email')" required autofocus autocomplete="username"class="form-control">
                                            </div>
